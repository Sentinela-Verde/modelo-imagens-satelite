"""Gera as figuras visuais da demo do classificador — imagem de satélite ao lado do que o modelo vê.
    ...
    python modelo-impacto/scripts/figuras_demo_visual.py
...
Saídas em `modelo-impacto/reports/figuras/demo/`.
"""
...
sys.path.insert(0, str(RAIZ / "modelo-impacto" / "scripts"))
DESTINO = RAIZ / "modelo-impacto" / "reports" / "figuras" / "demo"
