...
Rode com:
    ...
    python modelo-impacto/scripts/impacto_dc_25_expansao_amostra.py --fase lista
    python modelo-impacto/scripts/impacto_dc_25_expansao_amostra.py --fase controles
    python modelo-impacto/scripts/impacto_dc_25_expansao_amostra.py --fase classificar
