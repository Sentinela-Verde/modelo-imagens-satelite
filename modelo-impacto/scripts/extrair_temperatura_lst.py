...
repositório — ver `modelo-impacto/README.md`). NÃO mexe em `src/sentinela/`, `data/`,
...
`modelo-impacto/raw/temperatura/METODOLOGIA.md`.
...
Uso:
    .venv\\Scripts\\python.exe modelo-impacto\\scripts\\extrair_temperatura_lst.py
"""
