...
Rode com:
    ...
    python modelo-impacto/scripts/impacto_dc_40_modelo_conversao.py --fase dataset
    python modelo-impacto/scripts/impacto_dc_40_modelo_conversao.py --fase treinar
    python modelo-impacto/scripts/impacto_dc_40_modelo_conversao.py --fase avaliar
    python modelo-impacto/scripts/impacto_dc_40_modelo_conversao.py --fase ablacao

## A pergunta, e por que ela é diferente da que já falhou

A camada 2 do modelo de impacto (`modelo-impacto/scripts/score_02_explicacao.py`) pergunta
*"quanto este SÍTIO vai converter?"* e não se sustentou: 13 modelos, todos com R² LOOCV negativo
(`modelo-impacto/outputs/explicacao_modelos.csv`), permutação p=0,77. O N de lá é 13 campi.
