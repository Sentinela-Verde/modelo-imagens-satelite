...
Rode com:
    ...
    python modelo-impacto/scripts/impacto_dc_20_janela_estendida.py --fase classificar
    python modelo-impacto/scripts/impacto_dc_20_janela_estendida.py --fase analise
