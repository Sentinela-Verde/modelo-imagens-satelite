...
classificador principal, ver modelo-impacto/README.md). NAO mexe em src/sentinela/, data/,
...
Uso:
    .venv\\Scripts\\python.exe modelo-impacto\\scripts\\extrair_emprego.py

Nao recebe argumentos. Le config/sites.geojson (raiz do repo), escreve:
  - modelo-impacto/raw/emprego/*.json                    (respostas brutas da API, uma por
    chamada — o script cria esses arquivos, sobrescrevendo a cada execucao)
  - modelo-impacto/processed/emprego_municipal.csv

O arquivo modelo-impacto/raw/emprego/METODOLOGIA.md (pesquisa de fontes, decisao,
...
APOIO_DIR = SCRIPT_DIR.parent              # .../modelo-impacto
