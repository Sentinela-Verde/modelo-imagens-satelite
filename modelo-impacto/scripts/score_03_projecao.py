...
Rode com:
    ...
    python modelo-impacto/scripts/score_03_projecao.py                    # valida e publica as faixas
    python modelo-impacto/scripts/score_03_projecao.py --pct-ja-construida 15   # projeta um site novo
...
CORTE_GREENFIELD = 50.0  # % do footprint já construído (passo 15 de modelo-impacto)
