"""Gera e executa `notebooks/05_caracterizacao_americas.ipynb` — o estudo descritivo, N=612.
    ...
    python modelo-impacto/scripts/nb_05_descritivo.py
...
DADOS = RAIZ / "modelo-impacto" / "raw" / "controles-rf" / "descritivo_campi.csv"
...
d = pd.read_csv(RAIZ / "modelo-impacto" / "raw" / "controles-rf" / "descritivo_campi.csv")
