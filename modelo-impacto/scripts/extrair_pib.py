...
logica ja registrada para populacao e emprego em modelo-impacto/raw/{populacao,emprego}/
...
Escreve:
  - modelo-impacto/raw/pib/*.json (localidades) e pib_municipios_filtrado.csv (subset)
  - modelo-impacto/processed/pib_municipal.csv
"""
