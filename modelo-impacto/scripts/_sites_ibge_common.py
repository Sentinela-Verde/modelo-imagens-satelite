...
escolaridade) em modelo-impacto/scripts/. Nao e um script standalone — e importado por
...
Responsabilidades:
  1. Montar a lista de 19 sites (16 de config/sites.geojson + 3 novos do levantamento do
     ...
     modelo-impacto/raw/*/METODOLOGIA.md de cada variavel para o detalhe da reconciliacao).
