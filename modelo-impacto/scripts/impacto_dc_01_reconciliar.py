...
Rode com:
    ...
    python modelo-impacto/scripts/impacto_dc_01_reconciliar.py
...
**Gerado em:** {agora} por `modelo-impacto/scripts/impacto_dc_01_reconciliar.py`
...
`modelo-impacto/scripts/gerar_controles_pareados.py`), que resolve exatamente os quatro
pontos acima:
...
`modelo-impacto/raw/controles-rf/METODOLOGIA.md`.
