"""Consolida os dados levantados em modelo-impacto/ (+ area_por_classe.csv do classificador
principal) numa planilha unica, pra apoio ao modelo de impacto do Guilherme.

Rode com: python modelo-impacto/scripts/montar_planilha_consolidada.py

Gera:
  modelo-impacto/processed/consolidado_painel_anual.csv    -- site x ano, series continuas
  modelo-impacto/processed/consolidado_desemprego.csv      -- so 5/18 municipios (capitais)
  modelo-impacto/processed/consolidado_renda.csv           -- so 2022 (Censo)
  modelo-impacto/processed/consolidado_escolaridade.csv    -- 2 censos, formato longo
  modelo-impacto/processed/consolidado_facilities.csv      -- atributos estaticos por site
  modelo-impacto/processed/consolidado_apoio_impacto.xlsx  -- as 5 tabelas acima, uma aba cada
...
APOIO_DIR = REPO_ROOT / "modelo-impacto"
