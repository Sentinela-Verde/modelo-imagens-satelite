...
para populacao/emprego/PIB/renda em modelo-impacto/raw/*/METODOLOGIA.md e em
...
escreve:
  - modelo-impacto/raw/desemprego/*.json (localidades + respostas da tabela 4562)
  - modelo-impacto/processed/desemprego_municipal.csv
"""
