...
Rode com:
    ...
    python modelo-impacto/scripts/nb_02_impacto_score.py
...
**Frente:** `modelo-impacto/` · **Data:** 2026-09-10
...
sys.path.insert(0, str(REPO_ROOT / "modelo-impacto" / "scripts"))

import pandas as pd
import matplotlib.pyplot as plt
from IPython.display import Image, display

SCORE_DIR = REPO_ROOT / "modelo-impacto"
OUT = SCORE_DIR / "outputs"
FIG = SCORE_DIR / "reports" / "figuras"
RES = REPO_ROOT / "modelo-impacto" / "raw" / "controles-rf"
RES_FIG = RES / "figuras"
...
"""),
    code("""
import importlib
import projecao_demo  # noqa  (helper fino em modelo-impacto/scripts/)
...
Sumário executivo (1 página, sem p-valores): `modelo-impacto/reports/sumario-executivo.md`
Relatório completo: `modelo-impacto/reports/relatorio-impacto.md`
