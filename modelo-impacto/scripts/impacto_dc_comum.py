...
Contexto: `modelo-impacto/README.md` (escopo desta pasta) e
`modelo-impacto/raw/controles-rf/METODOLOGIA.md` (o desenho completo desta rodada).
...
DIR_SAIDA = REPO_ROOT / "modelo-impacto" / "raw" / "controles-rf"
DIR_FIGURAS = DIR_SAIDA / "figuras"
DIR_PROCESSED = REPO_ROOT / "modelo-impacto" / "processed"
...
def caminho_classificado(sensor_token: str, site_id: str, ano: int) -> Path:
    ...
    Pontos de CONTROLE ficam sob `modelo-impacto/raw/controles-rf/classificado/`. A
