...
modelo-impacto/README.md e docs/requisitos-dados-externos.md (secao 2) na raiz deste
...
Nao recebe argumentos. Le config/sites.geojson (raiz do repo), escreve:
  - modelo-impacto/raw/populacao/*.json          (respostas brutas da API, uma por chamada)
  - modelo-impacto/processed/populacao_municipal.csv
