...
- **Gerado por:** `modelo-impacto/scripts/impacto_dc_*.py` (passos 1–22) e
  `modelo-impacto/scripts/0{1,2,3}_*.py`
...
- **Classificador:** `rf_v1.0-tuned` · **Pareamento:** `modelo-impacto/raw/controles-rf/METODOLOGIA.md`
