...
Rode com:
    ...
    python dados-modelo-impacto/scripts/impacto_dc_33_ingerir_eua.py --fase ingerir
    python dados-modelo-impacto/scripts/impacto_dc_33_ingerir_eua.py --fase funil
