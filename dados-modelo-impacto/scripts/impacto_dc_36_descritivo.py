...
Rode com:
    ...
    python dados-modelo-impacto/scripts/impacto_dc_36_descritivo.py --fase medir
    python dados-modelo-impacto/scripts/impacto_dc_36_descritivo.py --fase relatar
