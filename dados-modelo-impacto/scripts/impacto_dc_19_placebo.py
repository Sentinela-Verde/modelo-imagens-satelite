...
Rode com (nesta ordem):
    ...
    python dados-modelo-impacto/scripts/impacto_dc_19_placebo.py --fase selecao
    python dados-modelo-impacto/scripts/impacto_dc_19_placebo.py --fase classificar
    python dados-modelo-impacto/scripts/impacto_dc_19_placebo.py --fase analise
