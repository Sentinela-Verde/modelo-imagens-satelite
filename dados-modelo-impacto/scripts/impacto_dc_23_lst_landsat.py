...
Rode com:
    ...
    python dados-modelo-impacto/scripts/impacto_dc_23_lst_landsat.py --fase baixar
    python dados-modelo-impacto/scripts/impacto_dc_23_lst_landsat.py --fase analise
