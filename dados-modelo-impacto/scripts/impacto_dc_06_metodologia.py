...
Rode com:
    ...
    python dados-modelo-impacto/scripts/impacto_dc_06_metodologia.py

Mesmo padrão dos `METODOLOGIA.md` já existentes em `dados-modelo-impacto/raw/*/`: o documento é
...
Gerado por `dados-modelo-impacto/scripts/impacto_dc_06_metodologia.py` em {agora}.
