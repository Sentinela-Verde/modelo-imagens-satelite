...
Rode com:
    ...
    python dados-modelo-impacto/scripts/impacto_dc_32_datar_landsat.py --fase serie
    python dados-modelo-impacto/scripts/impacto_dc_32_datar_landsat.py --fase validar
    python dados-modelo-impacto/scripts/impacto_dc_32_datar_landsat.py --fase datar
