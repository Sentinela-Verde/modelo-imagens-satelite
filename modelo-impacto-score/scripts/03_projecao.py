...
prever a mediana. Todos os R² fora-da-amostra são negativos e o teste de permutação dá p=0,53 — o
...
def main() -> int:
    ...
    if args.pct_ja_construida is not None:
        ...
        print("\nlembrete obrigatório: é a taxa-base de uma classe de referência, NÃO uma previsão "
              ...
              "(camada 2: R² LOOCV negativo em todos os modelos, permutação p=0,53).")
        return 0
